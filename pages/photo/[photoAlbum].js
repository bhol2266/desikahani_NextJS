...
function Album({ dload_links, relatedAlbums,href }) {
    ...
    const displaypics = dload_links.map((picURL, index) => {
        ...
        return (
           <SinglePicThumnail key={picURL} picData={picURL} index={index} href={href}/>
        )
    })
    ...
    return (
        ...
        <div className=" ">
            ...
            <div className='flex flex-col'>
                ...
                <div className={`${!showBigImage ? "" : "hidden"} grid grid-cols-2  gap-2 md:gap-3 lg:gap-4  md:grid-cols-3 `}>
...
export async function getStaticPaths() {
    ...
    return {
        paths: [{ params: { photoAlbum: 'chudasi-nri-biwi-ki-nude-aur-sex-photos' } }],
...
export async function getStaticProps(context) {
    ...
    return {
        props: {
            dload_links: resData.dataobject.imageArray,
