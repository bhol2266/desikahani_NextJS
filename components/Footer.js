...
function Footer() {
    ...
    return (
        ...
        <div className={`font-footer  bg-orange-300  ${spinnerLoading ? "hidden" : ""} `}>
            ...
            <div className='w-full p-4 text-center pt-10'>
                <p className='whitespace-normal break-words mb-2 px-4 text-sm'>
                    Hindisexstory is rated with RTA label. Parents, you can easily block access to this site.
                ...
                <p className='whitespace-normal break-words font-inter text-sm'>
                    © {new Date().getFullYear()} Hindisexstory.app is a Hindi Sex Stories Website
                </p>
            </div>
